...
//本模块默认数据总线类型为SPI总线
//     LCD模块                STM32单片机    
//       SDA         接          PC3         //液晶屏SPI总线数据写信号
//=======================================液晶屏控制线接线==========================================//
//     LCD模块 					      STM32单片机 
//       CLK         接          PB10         //液晶屏SPI总线时钟信号
...
{	
   ...
   uint8_t data_low = (uint8_t)Data;
   HAL_SPI_Transmit(&hspi2, &data_high, 1, HAL_MAX_DELAY);
   HAL_SPI_Transmit(&hspi2, &data_low, 1, HAL_MAX_DELAY);
   LCD_CS_SET;
}
